...
export type ClientInspectionReport = { id: string; scheduled_for: string; published_at: string | null; property: { id: string; display_name: string; locality: string }; overall_condition: InspectionCondition; client_summary: string | null; inspector: { display_name: string; role_title: string; profile_photo_path: string | null } | null; areas: InspectionArea[] }
