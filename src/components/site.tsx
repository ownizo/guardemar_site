...
export function ReportPreview() { return <div className="report-card"><div className="report-top"><div><span>GUARDEMAR</span><strong>Property Visit Report</strong></div><span className="status-good">Good</span></div><div className="report-meta"><span><Clock3 size={14} /> 14:30 · Scheduled visit</span><span><Camera size={14} /> 18 photographs</span></div><div className="report-row"><span>Security & access</span><strong className="status-good">Good</strong></div><div className="report-row"><span>Water & plumbing</span><strong className="status-attention">Attention</strong></div><div className="report-row"><span>Moisture & building</span><strong className="status-good">Good</strong></div><div className="report-observation"><CircleAlert size={18} /><div><strong>Observation</strong><p>Minor moisture visible below kitchen sink. Owner notified; plumber access recommended.</p></div></div><div className="report-images"><span /><span /><span /></div></div> }
