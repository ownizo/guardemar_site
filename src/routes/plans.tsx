...
export const Route = createFileRoute('/plans')({
  head: () => pageHead({
    title: 'Property Care Plans and Pricing | Guardemar',
    description: 'Guardemar property care plans from €79 per month for second homes and holiday homes in the Western Algarve, with optional additional services listed separately.',
    path: '/plans/',
...
function PlansPage() {
  return (
    <>
      ...
      <PageHero
        eyebrow="Care plans"
        title="Choose the inspection frequency. Confirm the property-specific scope."
        text="Plans set out the scheduled visit frequency and included care. The home watch assessment confirms access, systems and any additional coordination required."
        aside="For the primary service overview, start with Home Watch Algarve."
      />
      <section className="section warm-section">
        <div className="shell">
          <p className="eyebrow">Your Guardemar care plan</p>
          <h2 className="plans-primary-heading">CARE, CARE+ and COMPLETE remain the primary service.</h2>
        </div>
        ...
        <div className="shell plan-clarity">
          ...
          <p><a href="/home-watch-algarve/">Review the Home Watch Algarve service</a> before comparing frequencies.</p>
        </div>
      </section>
