...
export const Route = createFileRoute('/services')({ head: () => pageHead({ title: 'Property Care Service Directory | Guardemar', description: 'Focused guides to key holding, arrival preparation, contractor access, handovers and post-weather checks supporting the core home watch service.', path: '/services/' }), component: Services })
